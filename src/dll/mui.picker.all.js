...
(function ($, window, document, undefined) {
  var zoom = adaptive.fontSize / 20;
  var MAX_EXCEED = 30;
  var VISIBLE_RANGE = 180 * zoom;
  var DEFAULT_ITEM_HEIGHT = 80 * zoom;
  var BLUR_WIDTH = 20 * zoom;
  // var MAX_EXCEED = 30;
...
(function ($, document) {
  ...
  //TODO 加了title
  function createPanelBuffer(text) {
    //var panelBuffer =
    return '<div class="mui-poppicker">\
		<div class="mui-poppicker-header">\
			<button class="mui-btn mui-poppicker-btn-cancel">取消</button>\
			<button class="mui-btn mui-btn-blue mui-poppicker-btn-ok">确定</button>\
			<div class="mui-poppicker-clear"></div>\
			<div class="mui-poppicker-title">' + text + '</div>\
		</div>\
  ...
  var PopPicker = $.PopPicker = $.Class.extend({
    ...
    init: function (options) {
      ...
      //TODO 加了title
      self.panel = $.dom(createPanelBuffer(self.options.headText))[0];
