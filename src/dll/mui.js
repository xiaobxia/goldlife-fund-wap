...
(function($, window, document, undefined) {
	...
	var Scroll = $.Class.extend({
      ...
      //TODO 修复错位问题
		...
		// 		this.resetPosition();
		// 	}
      if ((!this.moved) || e.type === $.EVENT_CANCEL) {
        this.resetPosition();
      }
		},
        ...
        if(this.options.onTranslateStr) {
          this.options.onTranslateStr(x, y,'translate3d(' + x + 'px,' + y + 'px,0px) ' + this.translateZ);
        }
				return 'translate3d(' + x + 'px,' + y + 'px,0px) ' + this.translateZ;
			}
      if(this.options.onTranslateStr) {
        this.options.onTranslateStr(x, y,'translate(' + x + 'px,' + y + 'px) ');
      }
